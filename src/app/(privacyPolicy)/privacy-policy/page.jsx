      ...
      <Layout>
        <div className="privacy_outer">
          <div className="privacy_inner">
            ...
            <p> Privacy is of utmost importance to us and we are not here for your data. We assure you that we will also not spam you with unsolicited emails messages or calls. The Privacy Policy sets forth our policies regarding the collection use and protection of your personal information. Personal information means information that can be linked to a specific individual such as name address contact number e-mail address and IP address. We encourage you to review our Privacy Policy and become familiar with it but you should know that we do not sell or rent our customers personal information to third parties.</p>
            ...
            <p>
              ...
              When you register with us make a requisition for information pertaining to holiday packages subscribe to our newsletters share with us your experience or provide any other details in relation to a holiday package availed by you send us queries or register for promotions
            ...
            <h3>Automatic Logging of Session Data
            </h3>

            <p>We automatically log generic information about your computers connection to the Internet which we call session data that is anonymous and not linked to any personal information. Session data consists of things such as IP address operating system and type of browser software being used and the activities conducted by the user while on our site. We collect session data because it helps us analyze such things as what items visitors are likely to click on most the way visitors are clicking through the site how many visitors are surfing to various pages on the site how long visitors to the site are staying and how often they are visiting. It also helps us diagnose problems with our servers and lets us better administer our systems. Although such information does not identify any visitor personally it is possible to determine from an IP address a visitors Internet Service Provider (ISP) and the approximate geographic location of his or her point of connectivity.</p>
            ...
            <h3>With whom (if anyone) is your personal information is shared?</h3>
            <p>When you reserve or purchase travel services through us we must provide certain of your personal information to the airline hotel car-rental agency travel agency or other involved third party to enable the successful fulfillment of your travel arrangements. However we do not sell or rent individual customer names or other personal information to third parties. We use non-personally identifiable information in aggregate form to build higher quality more useful online services by performing statistical analysis of the collective characteristics and behavior of our customers and visitors and by measuring demographics and interests regarding specific areas of the our Site. We may provide anonymous statistical information based on this data to suppliers advertisers affiliates and other current and potential business partners. We may also use such aggregate data to inform these third parties as to the number of people who have seen and clicked on links to their web sites. Occasionally we will hire a third party to act on our behalf for projects such as market research surveys and contest - entry processing and will provide information to these third parties specifically for use in connection with these projects. The information we provide to such third parties is protected by a confidentiality agreement and is to be used solely for completing the specific project.</p>
            ...
            <h3>How you can opt-out of receiving our promotional communications?</h3>
            ...
            <h3>What safeguards we have in place to protect your personal information?</h3>
            ...
            <p>Our site contains links to other web sites. Please note that when you click on one of these links you are entering another web site for which we have no responsibility. We encourage you to read the privacy statements of all such sites as their policies may be materially different from this Privacy Policy. Of course you are solely responsible for maintaining the secrecy of your passwords. Please be very careful responsible and alert with this information especially whenever youre online.
              ...
              In addition to the circumstances described above we may disclose the our site member information if required to do so by law court order as requested by other government or law enforcement authority or in the good faith belief that disclosure is otherwise necessary or advisable including without limitation to protect the rights or properties of MTP Vacations Private Limited or any or all of its affiliates associates employees directors or officers or when we have reason to believe that disclosing the information is necessary to identify contact or bring legal action against someone who may be causing interference with our rights or properties whether intentionally or otherwise or when anyone else could be harmed by such activities.
            </p>


            <h3>Our Policy on Childrens Information
            </h3>

            <p>MyTravPlan is not directed to children under 13. If you learn that your minor child has provided us with personal information without your consent please contact us at privacy@mytravplan.com to delete.</p>


            <h3>Your rights qua personal information
            </h3>

            <p>If you wish to correct or delete your personal information then you write to our Data Protection Officer Mr. Ajay Sharma at privacy@mytravplan.com

              Please note that we review our Privacy Policy from time to time and we may make periodic changes to the policy in connection with that review. Therefore you may wish to bookmark this page and/or periodically review this page to make sure you have the latest version. Regardless of later updates we will abide by the privacy practices described to you in this Privacy Policy at the time you provided us with your personal information. You may always submit concerns regarding our Privacy Statement or our privacy practices via email to care@mytravplan.com. Please reference the privacy policy in your subject line. We look forward to having the opportunity to serve you!!

              If you have any grievance with respect to our use of your information you may communicate such grievance to the Grievance Officer Mr. Kapil Kapoor by writing to escalations@mytravplan.com

              For further escalation of a grievance  You may communicate to the Nodal Officer Mr. Rohit Verma by writing to nodal@mytravplan.com
            </p>
